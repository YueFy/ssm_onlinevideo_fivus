...
document.writeln("<a href='#' class='btn btn-primary'>QQ</a> <a href='https://openapi.baidu.com/oauth/2.0/authorize?response_type=code&client_id=QRNSQLU3qPwzW3VE6naC2zCui2TR2x9K&redirect_uri=http://localhost:8080/login/baidu_login.htm&display=popup'class='btn btn-danger'>百度</a> </div> </div> </div> </div> </div> </div> </div> </div> </div>")
